      ...
      if (sel == true) {
            function give() {
                  var interval = setInterval(function () {
                        ...
                        // For Thursday
                        else if (currentDate.getDay() == 4 && currentDate.getHours() < 12 && currentDate.getMinutes() < 11)
                        ...
                        else if (currentDate.getDay() == 5 && currentDate.getHours() == 9 || currentDate.getHours() == 10)
                        ...
                        else if (currentDate.getDay() == 5 && currentDate.getHours() == 11 && currentDate.getMinutes() >= 10 || currentDate.getHours() == 12 || currentDate.getHours() == 13 && currentDate.getMinutes() < 11)
